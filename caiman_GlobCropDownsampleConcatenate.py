...
import os,sys
animal_id = "191172"
notes = '20191028_30fps'
common_dir = os.path.join(r'/run/user/1000/gvfs/smb-share:server=10.10.46.135,share=data_archive/qiushou/miniscope/20191028*',animal_id,"H*M*S*")
